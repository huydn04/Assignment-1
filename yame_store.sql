...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 11, 2023 at 07:14 AM
...
INSERT INTO `bill` (`id`, `id_user`, `ma_donhang`, `nguoinhan_ten`, `nguoinhan_diachi`, `nguoinhan_sdt`, `nguoinhan_email`, `pt_thanhtoan`, `voucher`, `ship`, `tong_thanhtoan`, `ngay_dat_hang`, `order_notes`, `trangthai`) VALUES
(116, 138, 'MMT-891052493', 'Duy Trần', 'CVPM QUANG TRUNG', 346363160, 'gametopzero@gmail.com', 0, NULL, 0, 991000, '2023-12-05', '13213eqwqer', 3),
(117, 138, 'MMT-1673997423', 'Bình', 'CVPM QUANG TRUNG', 346363160, 'gametopzero@gmail.com', 0, NULL, 0, 1698000, '2023-12-05', '123213weqwe', 2),
(118, 141, 'MMT-1884917390', 'binh', 'gò vấp', 889020487, 'binhdtcl47@gmail.com', 0, NULL, 0, 457000, '2023-12-05', '', 2),
(119, 141, 'MMT-459961670', 'Bình', 'Gò Vấp', 889020487, 'binhk@gmail.com', 0, NULL, 0, 794000, '2023-12-06', '', 3),
(128, 141, 'MMT-1955470479', 'Bình', '472/56 Lê Đức Thọ , Phường 17, Gò vấp , HCM', 889020487, 'binhdtcl47@gmail.com', 0, NULL, 0, 357000, '2023-12-09', '', 3),
(129, 141, 'YM-727741100', 'Bình', '472/56 Lê Đức Thọ , Phường 17, Gò vấp , HCM', 889020487, 'binhdtcl47@gmail.com', 0, NULL, 0, 457000, '2023-12-10', '', 1),
(130, 141, 'YM-489869216', 'Bình', '472/56 Lê Đức Thọ , Phường 17, Gò vấp , HCM', 889020487, 'binhdtcl47@gmail.com', 0, NULL, 0, 357000, '2023-12-10', '', 3),
(131, 141, 'YM-1101625101', 'Duy Bình', '472/56 Lê Đức Thọ , Phường 17, Gò vấp , HCM', 889020487, 'binhdtcl47@gmail.com', 0, NULL, 0, 1116000, '2023-12-10', '', 1),
(132, 138, 'YM-1549719774', 'Nguyễn Trần Duy', '564/37/9', 346363180, 'duyntps29110@fpt.edu.vn', 0, NULL, 0, 2895000, '2023-12-11', '', 4),
(133, 138, 'YM-1359684886', 'Nguyễn Trần Duy', '564/37/9', 346363180, 'duyntps29110@fpt.edu.vn', 0, NULL, 0, 2106000, '2023-12-11', '', 1);

-- --------------------------------------------------------

--
-- Table structure for table `billchitiet`
--
...
--
-- Dumping data for table `billchitiet`
--

INSERT INTO `billchitiet` (`id`, `id_bill`, `id_product`, `id_user`, `so_luong`, `gia`, `thanh_tien`) VALUES
(36, 116, 42, 138, 1, 357000, 357000),
(37, 116, 41, 138, 1, 457000, 457000),
(38, 116, 40, 138, 1, 177000, 177000),
(39, 117, 41, 138, 3, 457000, 1371000),
(40, 117, 34, 138, 1, 327000, 327000),
(41, 118, 41, 141, 1, 457000, 457000),
(42, 119, 49, 141, 2, 397000, 794000),
(57, 130, 42, 141, 1, 357000, 357000),
(58, 131, 73, 141, 4, 279000, 1116000),
(59, 132, 41, 138, 1, 457000, 457000),
(60, 132, 38, 138, 2, 425000, 850000),
(61, 132, 45, 138, 4, 397000, 1588000),
(62, 133, 42, 138, 1, 357000, 357000),
(63, 133, 73, 138, 2, 279000, 558000),
(64, 133, 49, 138, 3, 397000, 1191000);
...
--
-- AUTO_INCREMENT for table `billchitiet`
--
ALTER TABLE `billchitiet`
...
--
ALTER TABLE `giohang`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT COMMENT 'Mã giỏ hàng', AUTO_INCREMENT=167;
...
--
ALTER TABLE `user`
  MODIFY `id` int(20) NOT NULL AUTO_INCREMENT COMMENT 'Mã khách hàng', AUTO_INCREMENT=142;
...
--
-- Constraints for table `billchitiet`
--
ALTER TABLE `billchitiet`
