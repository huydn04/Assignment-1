...
?>
    <div class="container main-secction" style="padding: 0px; ">
        <div class="" style="padding-bottom: 70px; border:5px solid black;">
...
<script>
  ...
  var change_pass = document.getElementsByClassName('change_pass')[0];
  var oldpass = document.getElementsByClassName('oldpass')[0];
  var newpass = document.getElementsByClassName('newpass')[0];
  var oldpass_Display = oldpass.style.display;
  var newpass_Display = newpass.style.display;
    change_pass.onclick = function(){
      var isClose = oldpass.style.display === oldpass_Display;
      if(isClose){
